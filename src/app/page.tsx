  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/azteca.jpg')",
      ...
      />
      {/* Dark gradient overlay so foreground text stays readable */}
      <div
        aria-hidden
        className="fixed inset-0 -z-10"
        style={{
          background:
            "linear-gradient(180deg, rgba(244,246,251,0.72) 0%, rgba(244,246,251,0.92) 100%)",
        }}
      />

      <main className="relative max-w-5xl mx-auto px-6 py-10 sm:py-16">

        {/* === Eyebrow: hosts === */}
        <div className="flex justify-center items-center gap-3 text-xs uppercase tracking-[0.4em] text-[var(--gold-deep)] opacity-95 mb-6">
          <span>🇨🇦</span>
          <span>Canada</span>
        ...
        <div className="text-center">
          ...
          <h1 className="text-5xl sm:text-7xl font-black tracking-tight leading-none mb-3">
            <span className="bg-gradient-to-b from-[#e3b034] to-[var(--gold-deep)] bg-clip-text text-transparent">
              World Cup
            </span>
            <span className="block text-[var(--text)] mt-1 text-4xl sm:text-6xl drop-shadow-sm">
              2026 Pool
            </span>
          </h1>

          <div className="inline-flex items-center gap-3 mt-2 px-4 py-1.5 rounded-full bg-[var(--card)] border border-[var(--border)] text-xs uppercase tracking-widest text-[var(--muted)] shadow-sm">
          ...
          <p className="text-base sm:text-lg text-[var(--text)] mt-7 max-w-xl mx-auto leading-relaxed">
            Pick scores for every match. Earn <span className="text-[var(--gold-deep)] font-bold">3 points</span> for an exact score,
          ...
          <p className="mt-6 text-[10px] uppercase tracking-[0.3em] text-[var(--muted)] opacity-80">
        ...
        <div className="text-center mt-12 text-xs text-[var(--muted)]">
          Free family + friends pool. No ads.
        </div>
      </main>
    </>
  );
...
function Feature({ icon, title, body }: { icon: string; title: string; body: string }) {
  return (
    <div className="card text-left relative overflow-hidden backdrop-blur-sm bg-[rgba(255,255,255,0.85)]">
