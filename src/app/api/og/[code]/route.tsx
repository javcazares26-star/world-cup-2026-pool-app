...
export async function GET(req: Request, { params }: { params: { code: string } }) {
  ...
  if (!pool) {
    return new ImageResponse(<div style={{ background: "#0a0e1f", color: "#fff", width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 48 }}>Pool not found</div>, { width: 1200, height: 630 });
  }
  ...
  return new ImageResponse(
    (
      <div style={{
        ...
        background: "linear-gradient(135deg, #c11a36 0%, #b8841a 100%)",
